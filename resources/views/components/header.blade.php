            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    ...
                    @if (session('super_admin') && !empty(session('super_admin')))
                        <a class="btn btn-dark" href="{{ route('backtoadmin') }}?admin=1">
                            <i class="fa fa-arrow-left"></i>
                            Back to Super Admin</a>
                        <div class="dropdown-divider"></div>
                    @endif

                    @if (session('company_admin') && !empty(session('company_admin')))
                        <a class="btn btn-dark" href="{{ route('backtoadmin') }}?company=1"><i
                                class="dripicons-back text-muted mr-2 d-none"></i>Back to Agency</a>
                        <div class="dropdown-divider"></div>
                    @endif
                </div>
                <!--end::switch account-->
